...
Имеет возможность связи с приложением Home Assistant через интеграцию  MQTT.
Поддержка контроллера  в телеграмм канале: https://t.me/hotbed_agro 
